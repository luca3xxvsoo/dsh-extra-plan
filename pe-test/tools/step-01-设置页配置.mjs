...
check('client.js：configForms.whileServed + plugins.bundle.config（key = @local/dsh-extra-plan；无 order / 无 plugins.item 卡片注册 / 无 settings.plugin.item / 无 plugins.row.config）', clientCode.includes('ctx.configForms.whileServed([NS]') && clientCode.includes('ctx.slots.inject("plugins.bundle.config"') && clientCode.includes('name: "plugins.bundle.config"') && clientCode.includes('"@local/dsh-extra-plan"') && !clientCode.includes('plugins.row.config') && !clientCode.includes('"plugins.item"') && !clientCode.includes('order: 90') && !clientCode.includes('settings.plugin.item') && !clientCode.includes('key: "dsh-extra-plan"'))
